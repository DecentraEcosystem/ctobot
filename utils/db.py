...
Stores: posted_mints, tracked_tokens, sent_messages.
...
def init_db():
    ...
    with _conn() as con:
        con.executescript("""
            ...
            -- Anti-doppioni messaggi generici
...
CREATE TABLE IF NOT EXISTS settings (
    ...
    for migration in [
        ...
        "ALTER TABLE tracked_tokens ADD COLUMN plan TEXT NOT NULL DEFAULT ''",        "ALTER TABLE tracked_tokens ADD COLUMN logo_url TEXT NOT NULL DEFAULT ''",
